...
func _ready():
	...
	$Tank0/Polygon2D.color = Color(0.8, 1, 0)
	$Tank0.og_color = Color(0.8, 1, 0)
	$Tank1/Polygon2D.color = Color(1, 0.8, 0)
	$Tank1.og_color = Color(1, 0.8, 0)
	$Tank2/Polygon2D.color = Color(0, 1, 0.8)
	$Tank2.og_color = Color(0, 1, 0.8)
	$Tank3/Polygon2D.color = Color(0, 0.8, 1)
	$Tank3.og_color = Color(0, 0.8, 1)
